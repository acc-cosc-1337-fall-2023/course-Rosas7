...
TEST_CASE("Test non static function", "value of num wil not persist across function")
{
...
TEST_CASE("Test static_2 funciton", "????")
{
...
TEST_CASE("Test function value overloads")
{
